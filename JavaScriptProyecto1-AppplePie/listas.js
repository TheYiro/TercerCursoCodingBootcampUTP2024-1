...
preguntarLista('Ingrese la lista de numeros separados por comas para encontrar el mayor y el menor: ', (numeros) => { // Se llama a preguntarLista para pedir al usuario la lista de números.
    ...
    console.log("El numero mas pequeno es:", menor); // Se imprime por consola el número más grande y el más pequeño.
    preguntarLista('Ingrese la primera lista de numeros separados por comas: ', (lista1) => { // Se pide al usuario que ingrese la primera lista de números.
        preguntarLista('Ingrese la segunda lista de numeros separados por comas: ', (lista2) => { // Se pide al usuario que ingrese la segunda lista de números.
            ...
            preguntarLista('Ingrese la lista de numeros separados por comas para invertir: ', (listaOriginal) => { // Se pide al usuario que ingrese la lista de números para invertir.
...
Este programa en JavaScript realiza varias operaciones sobre listas de numeros ingresadas por el usuario a traves de la consola.
Encontrar el mayor y el menor numero: El programa solicita al usuario ingresar una lista de numeros separados por comas.
Luego, encuentra el número mas grande y el mas pequeño de la lista utilizando la funcion encontrarMayorYMenor.
Muestra por consola el numero mas grande y el mas pequeño.
Concatenar y ordenar dos listas de numeros:
Pide al usuario ingresar dos listas de numeros separados por comas.
Luego, concatena estas dos listas utilizando la funcion concatenarYOrdenar.
...
Solicita al usuario ingresar una lista de numeros separados por comas.
Utiliza la funcion invertirLista para invertir la lista ingresada.
